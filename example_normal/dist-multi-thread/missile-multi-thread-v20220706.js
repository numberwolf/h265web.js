...
if (!ENVIRONMENT_IS_PTHREAD) {
    var STACK_BASE = 1402192,
        STACK_MAX = 6645072,
        DYNAMIC_BASE = 6645072,
        DYNAMICTOP_PTR = 1401168;
...
var wasmBinaryFile = "missile-multi-thread-v20220706.wasm";
...
if (!ENVIRONMENT_IS_PTHREAD) {
    memoryInitializer = "missile-multi-thread-v20220706.html.mem"
}
var tempDoublePtr;
if (!ENVIRONMENT_IS_PTHREAD) tempDoublePtr = 1402176;
...
else PthreadWorkerInit.__main_thread_futex_wait_address = __main_thread_futex_wait_address = 1402160;
...
var PThread = {
    ...
    initMainThreadBlock: function() {
        ...
        PThread.mainThreadBlock = 1401376;
...
if (d.cmd === "goexit") {
    ...
    createNewWorkers: function(numWorkers) {
        if (typeof SharedArrayBuffer === "undefined") return [];
        var pthreadMainJs = "missile-multi-thread-v20220706.worker.js";
...
else PthreadWorkerInit._fetch_work_queue = _fetch_work_queue = 1401360;
...
else PthreadWorkerInit.___tm_timezone = ___tm_timezone = (stringToUTF8("GMT", 1401264, 4), 1401264);
