...
if (!ENVIRONMENT_IS_PTHREAD) {
    var STACK_BASE = 1402432,
        STACK_MAX = 6645312,
        DYNAMIC_BASE = 6645312,
        DYNAMICTOP_PTR = 1401408;
...
var wasmBinaryFile = "missile-multi-thread-v20221120.wasm";
...
if (!ENVIRONMENT_IS_PTHREAD) {
    memoryInitializer = "missile-multi-thread-v20221120.html.mem"
}
var tempDoublePtr;
if (!ENVIRONMENT_IS_PTHREAD) tempDoublePtr = 1402416;
...
else PthreadWorkerInit.__main_thread_futex_wait_address = __main_thread_futex_wait_address = 1402400;
...
var PThread = {
    ...
    initMainThreadBlock: function() {
        ...
        PThread.mainThreadBlock = 1401616;
...
if (d.cmd === "goexit") {
    ...
    createNewWorkers: function(numWorkers) {
        if (typeof SharedArrayBuffer === "undefined") return [];
        var pthreadMainJs = "missile-multi-thread-v20221120.worker.js";
...
else PthreadWorkerInit._fetch_work_queue = _fetch_work_queue = 1401600;
...
else PthreadWorkerInit.___tm_timezone = ___tm_timezone = (stringToUTF8("GMT", 1401504, 4), 1401504);
