...
if (!ENVIRONMENT_IS_PTHREAD) {
    var STACK_BASE = 1401936,
        STACK_MAX = 6644816,
        DYNAMIC_BASE = 6644816,
        DYNAMICTOP_PTR = 1400912;
...
var wasmBinaryFile = "missile-multi-thread-v20220623.wasm";
...
if (!ENVIRONMENT_IS_PTHREAD) {
    memoryInitializer = "missile-multi-thread-v20220623.html.mem"
}
var tempDoublePtr;
if (!ENVIRONMENT_IS_PTHREAD) tempDoublePtr = 1401920;
...
else PthreadWorkerInit.__main_thread_futex_wait_address = __main_thread_futex_wait_address = 1401904;
...
var PThread = {
    ...
    initMainThreadBlock: function() {
        ...
        PThread.mainThreadBlock = 1401120;
...
if (d.cmd === "goexit") {
    ...
    createNewWorkers: function(numWorkers) {
        if (typeof SharedArrayBuffer === "undefined") return [];
        var pthreadMainJs = "missile-multi-thread-v20220623.worker.js";
...
else PthreadWorkerInit._fetch_work_queue = _fetch_work_queue = 1401104;
...
else PthreadWorkerInit.___tm_timezone = ___tm_timezone = (stringToUTF8("GMT", 1401008, 4), 1401008);
