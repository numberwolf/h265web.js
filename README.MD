...
* I will write a document for this framework.
...
You can use it in `localhost` | `127.0.0.1`, if you want to use it for others domain, please contact me, I will add your domain to whitelist~
...
Play
> <img src="./resource/demo3.png" width="500px" />
...
* Support cache buffer option

* Support restart and seek when pause.

* Support show first frame of video

* Support Mp4 with AVC Codec Play!
...
* And wechat account number in issue
