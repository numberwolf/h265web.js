...
| \+ coreProbePart  | Float32 | - | 否:Default is 1.0 | Probe Mp4 media info，interval: `0.0~1.0`, transition mp4 file which moov in the mp4 head, use 0.1(10%) （only with New player core(beta)) |
