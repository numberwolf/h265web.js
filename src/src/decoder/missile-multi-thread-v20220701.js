...
if (!ENVIRONMENT_IS_PTHREAD) {
    var STACK_BASE = 1401904,
        STACK_MAX = 6644784,
        DYNAMIC_BASE = 6644784,
        DYNAMICTOP_PTR = 1400880;
...
if (!ENVIRONMENT_IS_PTHREAD) addOnPreRun(function() {
    if (typeof SharedArrayBuffer !== "undefined") {
        ...
        PThread.allocateUnusedWorkers(10, function() {
...
var wasmBinaryFile = "missile-multi-thread-v20220701.wasm";
...
if (!ENVIRONMENT_IS_PTHREAD) {
    memoryInitializer = "missile-multi-thread-v20220701.html.mem"
}
var tempDoublePtr;
if (!ENVIRONMENT_IS_PTHREAD) tempDoublePtr = 1401888;
...
else PthreadWorkerInit.__main_thread_futex_wait_address = __main_thread_futex_wait_address = 1401872;
...
var PThread = {
    ...
    initMainThreadBlock: function() {
        ...
        PThread.mainThreadBlock = 1401088;
    ...
    createNewWorkers: function(numWorkers) {
        if (typeof SharedArrayBuffer === "undefined") return [];
        var pthreadMainJs = "missile-multi-thread-v20220701.worker.js";
...
else PthreadWorkerInit._fetch_work_queue = _fetch_work_queue = 1401072;
...
else PthreadWorkerInit.___tm_timezone = ___tm_timezone = (stringToUTF8("GMT", 1400976, 4), 1400976);
